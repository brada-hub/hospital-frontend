<template>
  <div class="tratamientos-readonly-container">
    <div class="header-section">
      <div class="text-h6 text-weight-medium titulo-principal">Tratamientos Activos</div>
            ...
            <q-item-section>
              ...
              <div v-if="!isLoading[tratamiento.id]" class="receta-content">
                <div class="receta-info-header">
                  ...
                  >
                    <div class="timer-label">Próxima dosis en:</div>
                ...
                <div class="cronograma-section">
                  ...
                  >
                    ...
                    <span class="empty-text">Sin tomas programadas para este día</span>
                  </div>
                    ...
                    >
                        ...
                        <div class="toma-info">
                          ...
                          <div class="toma-details">
                            <span class="toma-label">{{
                              toma.esPrimeraDosis ? 'INICIO' : formatHora(toma.horaReal)
                            }}</span>
                      ...
                      <div class="card-body">
                        <div v-if="toma.datosAdministracion" class="info-item">
                          ...
                          <span class="info-label">Administrado por:</span>
                        ...
                        >
                          ...
                          <span class="info-value">Pendiente de administración</span>
                        </div>
                      </div>
                    </div>
                  </div>
...
import { format, isPast, differenceInMilliseconds, addDays } from 'date-fns'

const props = defineProps({
  internacion: { type: Object, required: true },
})
...
<style scoped>
.tratamientos-readonly-container {
  width: 100%;
  padding: 24px;
  background: #f8fafc;
  border-radius: 8px;
